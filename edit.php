...
$id = $_REQUEST['id'];
$sql = "SELECT * FROM oldcustomer WHERE CUS_ID = '$id'";
...
<br>
<br>
  <center><h1>แก้ไขข้อมูลลูกค้า</h1></center>
  <br><br><br>
  <form id='form1' name='form1' method='post' action='success.php'>
    <p><b>รหัส ID <tab2>: </b><input type="text" name="id" id ="readonly" readonly="readonly" value="<?=$result['CUS_ID']?>">
    <p><b>ชื่อ : </b>
    <input name="name" type="text" id="name" value="<?=$result['CUS_FNAME']?>" /><tab4>
    <b>นามสกุล : </b>
    <input name="surname" type="text" id="surname" value="<?=$result['CUS_LNAME']?>" /></p>
    <p><b>ที่อยู่ : </b>
    <input name="address" type ="text" id="address" value="<?=$result['CUS_ADDRESS']?>"</p>
    <p><b>เบอร์โทรศัพท์ : </b>
    <input name="phone" type="text" id="phone" value="<?=$result['CUS_PHONE']?>" /></p>
    <br><br><br>
