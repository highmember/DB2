...
$wh_descript = $_POST['descript'];
$wh_num = $_POST['num'];
$id = $_REQUEST['id'];

$sql_edit = "UPDATE warehouse SET wh_descript = '$wh_descript' , wh_num = '$wh_num' where wh_id = '$id'";
...
<div id="body">
  ...
  <form action="warehouse.php">
    ...
    <form action="newwarehouse.php">
      <center><input type="submit" name="gonewvender" id="send" value="เพิ่มคลังสินค้าใหม่" /></center></form>
