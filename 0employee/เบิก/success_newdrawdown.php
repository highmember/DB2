...
$sql_salary = "select * from billsalary where emp_id = '$id'";
$dbquery = mysqli_query($link,$sql_salary);
$salary = mysqli_fetch_array($dbquery);
echo $sql_salary;
if($_POST['Add'])
{
...
$date = $_POST['date'];
$note = $_POST['note'];
$remain = $salary['billsa_balance'] - $credit;
$sql_add = "insert into billwithdraw set emp_id = '$id' , wd_credit = '$credit' , wd_date = '$date', wd_remain = '$remain', wd_note = '$note' ";
mysqli_query($link,$sql_add) ;
echo $remain;
echo "==========";
echo $sql_add;
$withdawn = $salary['billsa_withdawn'] + $credit;
$sql_addsalary = "update billsalary set billsa_withdawn = '$withdawn' , billsa_balance = '$remain' where emp_id = '$id'";
mysqli_query($link,$sql_addsalary) ;
}
