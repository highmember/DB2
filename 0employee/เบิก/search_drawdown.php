...
<?
	...
	while($objResult = mysqli_fetch_array($dbquery))
	{
	 if($i==0){
	  ...
	  <tr>
		<th width="91"> <div align="center">รหัส employee</div></th>
	  ...
	  echo "<tr>";
		echo "<td><a href = 'drawdown_showemp.php?id=$objResult[emp_id]'>$objResult[emp_id]</a></td>" ;
		echo "<td><a href = 'drawdown_showemp.php?id=$objResult[emp_id]'>$objResult[emp_fname]</a></td>" ;
		echo "<td><a href = 'drawdown_showemp.php?id=$objResult[emp_id]'>$objResult[emp_tel]</a></td>" ;
	  echo "<tr>";
