...
<form name="frmSearch" method="post" action="search_drawdown.php">
...
echo '<ul>';
echo '<tr>';
echo "<td><a href = 'drawdown_showemp.php?id=$result[emp_id]'>$result[emp_id]</a></td>" ;
echo "<td><a href = 'drawdown_showemp.php?id=$result[emp_id]'>$result[emp_fname]</a>   <a href = 'drawdown_showemp.php?id=$result[emp_id]'>$result[emp_lname]</a></td>" ;
echo "<td><a href = 'drawdown_showemp.php?id=$result[emp_id]'>$result[emp_tel]</a></td>" ;
echo '</tr>'; 
echo '</ul>';
$i++;
}
