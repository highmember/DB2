...
<div id="body">
<br><br><br><br><br><center><h1>ลา</h1><br><br><br>
<form name="frmSearch" method="post" action="search_leave.php">
  <center>
      <th>ตัวเลือกค้นหา
...
echo '<ul>';
echo '<tr>';
echo "<td><a href = 'show_leave.php?id=$result[emp_id]'>$result[emp_id]</a></td>" ;
echo "<td><a href = 'show_leave.php?id=$result[emp_id]'>$result[emp_fname]</a>   <a href = 'show_leave.php?id=$result[emp_id]'>$result[emp_lname]</a></td>" ;
echo "<td><a href = 'show_leave.php?id=$result[emp_id]'>$result[emp_tel]</a></td>" ;
echo '</tr>';
echo '</ul>';
$i++;
}
