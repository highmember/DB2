...
<?
	...
	while($objResult = mysqli_fetch_array($dbquery))
	{
	 if($i==0){
		 ...
		 <center><table>
	  <tr>
		<th>รหัส employee</div></th>
		<th>ชื่อพนักงาน</div></th>
		<th>เบอร์โทรศัพท์ </div></th>
	  </tr>
		 <?
		 $i++;
	 }
	  echo "<tr>";
		echo "<td><a href = 'show_salary.php?id=$objResult[emp_id]'>$objResult[emp_id]</a></td>" ;
		echo "<td><a href = 'show_salary.php?id=$objResult[emp_id]'>$objResult[emp_fname]</a></td>" ;
		echo "<td><a href = 'show_salary.php?id=$objResult[emp_id]'>$objResult[emp_tel]</a></td>" ;
	  echo "<tr>";
