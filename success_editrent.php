...
if($_POST['Edit'])
{
$rent_descript = $_POST['descript'];
$rent_price = $_POST['price'];
$rent_date = $_POST['date'];
$id = $_REQUEST['id'];

$sql_edit = "UPDATE rent SET rent_descript = '$rent_descript' , rent_price = '$rent_price' , rent_date = '$rent_date' where rent_id = '$id'";
