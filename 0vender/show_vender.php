...
<?php
 while($i < $num_rows)
 {
	...
	if($result[ven_id]==$_GET['id'])
	{
	echo '<ul>';
	echo '<tr>';
	echo "<td>$result[ven_id]</td>" ;
	echo "<td>$result[ven_name_company]</td>" ;
	echo "<td>$result[ven_contact]</td>" ;
	echo "<td>$result[ven_address]</td>" ;
	echo "<td>$result[ven_phone]</td>" ;
	echo "<td><a href = 'edit_vender.php?id=$result[ven_id]'>แก้ไข</a></td>"  ;
	//echo "<td><a href = 'delete_vender.php?id=$result[ven_id]'>ลบ</a></td>"  ;
	echo '</tr>'; 
	echo '</ul>';
	}
	$i++;
