...
<div id="body">
<br><br><br><br><br><center><h1>ค้นหาพนักงานเก่า</h1><br><br><br>

<form name="frmSearch" method="post" action="search_emp.php">
      <th>ตัวเลือกค้นหา
      ...
      <input type="submit" value="ค้นหา"></th></center>
</form>
<br><br><br>
<center>
<table>
...
echo '<ul>';
echo '<tr>';
echo "<td><a href = 'show_emp.php?id=$result[emp_id]'>$result[emp_id]</a></td>" ;
echo "<td><a href = 'show_emp.php?id=$result[emp_id]'>$result[emp_fname]  $result[emp_lname]</a></td>" ;
echo "<td><a href = 'show_emp.php?id=$result[emp_id]'>$result[emp_tel]</a></td>" ;
echo '</tr>';
echo '</ul>';
$i++;
}
