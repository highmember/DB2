...
<?
	...
	while($objResult = mysqli_fetch_array($dbquery))
	{
	 if($i==0){
	  ...
	  echo "<tr>";
		echo "<td><a href = 'show_leave.php?id=$objResult[emp_id]'>$objResult[emp_id]</a></td>" ;
		echo "<td><a href = 'show_leave.php?id=$objResult[emp_id]'>$objResult[emp_fname]</a></td>" ;
		echo "<td><a href = 'show_leave.php?id=$objResult[emp_id]'>$objResult[emp_tel]</a></td>" ;
	  echo "<tr>";
