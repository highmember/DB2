...
<?
	...
	while($objResult = mysqli_fetch_array($dbquery))
	{
	 if($i==0){
	  ...
	  echo "<tr>";
		echo "<td><a href = 'showprojreceipt.php?id=$objResult[CUS_ID]'>$objResult[proj_id]</td>" ;
		echo "<td><a href = 'showprojreceipt.php?id=$objResult[CUS_ID]'><div align='center'>$objResult[CUS_ID] </div></a></td>" ;
		echo "<td><a href = 'showprojreceipt.php?id=$objResult[CUS_ID]'><div align='center'>$objResult[proj_detail]</a></td>" ;
	  echo "<tr>";
