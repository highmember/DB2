  ...
  <div id="body">
    <br><br><br><br><br>
      ...
      <form action="oldcustomers.php">
		    <center><input type="submit" name="gotooldcustomer" id="send" value="ค้นหาลูกค้าเก่า" /></center></form>
        <form action="newcustomers.php">
		    <center><input type="submit" name="gotonewcustomer" id="send" value="เพิ่มลูกค้าใหม่" /></center></form>
